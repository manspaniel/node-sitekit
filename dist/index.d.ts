...
declare class SiteInstance extends EventEmitter {
    ...
    resizeToFit(width: any, height: any, viewportWidth: any, viewportHeight: any, cover: any): {};
    forceResizeWindow(): void;
    preloadPages(): void;
    getRefreshes(target: any): any;
    doRefreshes(result: any): {
        swapping: {
            items: any[];
    ...
    generateReplaceState(s: any): {
        scrollY: number;
        scrollX: number;
    };
    transitionWidgetsIn(targetEl: any, newState: any, oldState: any, callback: any): void;
    transitionWidgetsOut(targetEl: any, newState: any, oldState: any, destroy: any, callback: any): void;
    wrapXHRInner(): void;
...
interface BaseWidget {
    ...
    xhrPageWillLoad?(urlPath: string, url: string, direction: 'back' | 'forward'): boolean;
    [k: string]: any;
}
export declare function Widget<T extends BaseWidget>(name: string, def: T): {
    isWidget: boolean;
    name: string;
    def: T;
};
